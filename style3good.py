...
class SnakeGame:
    ...
    def setup_sounds(self):
        # Definir sonido para comer comida
        pyxel.sounds[0].set(
            "c3e3g3c4", "t", "7", "vffn", 25
        )
        # Definir sonido para game over
        pyxel.sounds[1].set(
            "g2b2d3g3", "t", "7", "vffn", 25
        )

        # Definir sonidos de música
        pyxel.sounds[2].set(
    ...
    def load_high_scores(self):
        try:
            with open("high_scores.txt", "r") as file:
                self.high_scores = [line.strip().split() for line in file.readlines()]
                self.high_scores = [(int(score), initials) for score, initials in self.high_scores]
    ...
    def spawn_obstacles(self):
        # Genera 5 obstáculos en posiciones aleatorias que no coincidan con la serpiente o la comida
        for _ in range(5):
            while True:
    ...
    def update_snake(self):
        ...
        if new_head == self.food:
            ...
            if self.score == 80:
                self.spawn_obstacles()  # Generar obstáculos a partir de los 80 puntos
        else:
    ...
    def draw_start_screen(self):
        ...
        # Dibuja una serpiente y una comida simple
    ...
    def draw_playing_screen(self):
        ...
        for obstacle in self.obstacles:
            pyxel.rect(obstacle[0], obstacle[1], 8, 8, 10)  # Dibuja obstáculos como rectángulos (color rojo brillante)
